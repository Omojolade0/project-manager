...
def get_all_project_notes(project_id: int, user_id: int, session: Session):
  project_checker(project_id, user_id, session)
  results = session.exec(select(Note).where(Note.project_id == project_id)).all()
  return results 

def get_note_by_id(project_id: int, note_id: int, user_id: int, session: Session):
  project_checker(project_id, user_id, session)
...
def create_note(project_id: int, data, user_id: int, session: Session):
  project_checker(project_id, user_id, session)
...
def delete_note(project_id: int, note_id:int, user_id: int, session: Session):
  project_checker(project_id, user_id, session)
...
def update_note(project_id: int, note_id:int, data, user_id: int, session: Session):
  project_checker(project_id, user_id, session)
